    ...
    images: {
      solo: [
        ...
        { src: '/images/markettoo-admin/pj-markettoo-admin-3.jpg' },
        {
          ...
          title: '디자인 시스템 : UX/UI 직관성 강화',
          desc: `레이아웃은 최소 해상도 1440px을 기준으로 제작했으며, 브라우저 가로 사이즈가 확대되는 경우 좌측 내비게이션은 고정되고 콘텐츠 영역만 유연하게 확장되도록 구성했습니다. 콘텐츠 영역은 반응형 대응을 위해 12-column 그리드 시스템을 기반으로 다양한 해상도에서 동일한 경험을 제공할 수 있도록 가변 레이아웃을 구성했습니다.
또한, 일관된 UI 제공을 위해 디자인 시스템을 구축했습니다. 텍스트 컬러와 인터페이스 간의 명도 대비를 고려한 컬러 시스템을 통해 접근성도 함께 확보했습니다.`,
        },
        ...
        { src: '/images/markettoo-admin/pj-markettoo-admin-8.jpg' },
        {
          ...
          title: '상품, 주문 관리',
          desc: `상품 관리와 매출 관리 화면은 점주들이 가장 자주 활용하는 핵심 기능으로, 실사용 흐름을 기반으로 UX를 설계했습니다. 상품 등록은 복잡한 항목을 최소화하고 필수 입력만 먼저 보이도록 하여, 비숙련 사용자도 부담 없이 접근할 수 있도록 구성했습니다.
또한 주문 및 매출 페이지는 단순 수치 나열이 아닌, 운영자가 빠르게 현황을 파악할 수 있도록 그래프와 텍스트를 조합해 정보의 가독성과 전달력을 높이는 데 집중했습니다.`,
        },
